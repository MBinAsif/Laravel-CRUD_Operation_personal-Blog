        ...
        <div class="recipe-top">
            <div class="container-fluid">
                <div class="recipe-actions">
                    <a style="margin-left: 90%" href="{{ route('recipes.create') }}" class="btn btn-success">Create New Recipe</a>
                </div>
                ...
                <img style="margin-left: 275px" src="https://www.chicken.ca/wp-content/uploads/2013/05/Moist-Chicken-Burgers.jpg" alt="">
            </div>
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="recipe-right">
                        ...
                        <div class="recipe-actions">
                            ...
                            <form action="{{ route('recipes.destroy', ['recipe' => $recipe->id]) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
